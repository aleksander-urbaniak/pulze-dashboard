...
export default function AppHeader({ title, user, onLogout }: AppHeaderProps) {
  ...
  return (
    <header className="nav-static sticky top-0 z-30 border-b border-border/70 bg-base/70 backdrop-blur">
      <div className="mx-auto max-w-6xl px-4 py-4 sm:px-6 sm:py-5">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden rounded-full border border-border px-4 py-2 text-xs uppercase tracking-[0.2em] sm:block">
