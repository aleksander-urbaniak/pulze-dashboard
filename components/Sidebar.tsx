...
export default function Sidebar({ onLogout, onOpenProfileEditor, settingsTabs }: SidebarProps) {
  ...
  return (
    ...
    >
      <div
        className={clsx(
          "flex items-start justify-between gap-3 md:flex-col md:items-center md:justify-start md:gap-2"
        )}
      >
        <Link
          href="/"
          ...
          {!isCollapsed ? (
            <div className="flex flex-col">
              <div className="flex items-center gap-3">
                <span className="brand-logo radius-ui flex h-9 w-9 shrink-0 items-center justify-center border border-accent/45 bg-accent text-on-accent shadow-[0_0_20px_rgb(var(--accent)/0.32)]">
                ...
                <p className="leading-tight text-[1.08rem] font-semibold uppercase tracking-[0.08em] text-text">
      ...
      >
        ...
        {!isCollapsed ? (
          <p className="px-2 pb-2 pt-4 text-center text-[10px] uppercase tracking-[0.2em] text-muted">
            Version {appVersion}
          </p>
        ) : null}
        ...
        <div
          className={clsx(
            ...
            isCollapsed && "md:flex md:flex-col md:items-center md:space-y-2 md:px-0"
          )}
        >
          <div
            className="relative"
          ...
          {onLogout ? (
            <button
              ...
              className={clsx(
                ...
                isCollapsed ? "justify-center md:h-10 md:w-10 md:px-0" : "justify-center gap-2"
              )}
            >
